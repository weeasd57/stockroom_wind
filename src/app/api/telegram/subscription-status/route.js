...
// Check if current user is subscribed to a broker's Telegram bot
export async function POST(request) {
  try {
    ...
    // Check subscription status using platform_user_id
    ...
    console.error('[Telegram Subscription Status] Error:', error);
